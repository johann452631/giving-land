<div
    ...
    <a class="flex items-center text-decoration-none cursor-pointer" href={{ route('home') }}>
        ...
        <span class="texto-verde font-bold text-xl">Giving-Land</span>
    </a>
                ...
                <div class="py-1" role="none">
                    ...
                    <form method="POST" action={{ route('app.logout') }} role="none">
                        ...
                        <a onclick="this.closest('form').submit()" type="submit"
                            class="text-gray-700 block w-full px-4 py-2 text-left text-sm cursor-pointer" role="menuitem"
                            tabindex="-1" id="menu-item-3">Sign out</a>
                    </form>
                </div>
            </div>
        </div>
    ...
    @guest
        <div class="d-flex">
            <a class="boton-base verde-blanco ps-3 pe-3 pt-1 pb-1 me-2" href={{ route('login.index') }}>Inicio sesion</a>
