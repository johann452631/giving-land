            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="max-w-96">
                    ...
                    <div class="mb-6">
                        <label class="texto-verde text-lg">
                            ...
                            <select name="purpose" id="purpose_select"
                                ...
                                <option value="0" disabled selected>Seleccione el propósito</option>
                    ...
                    <div class="mb-6">
                        <label class="texto-verde text-lg">
                            Descripción
                            <textarea class="text-gray-900" name="description" id="" rows="3"></textarea>
                        </label>
                    </div>
                    <div class="mb-6">
                        <label class="texto-verde text-lg">
                            Ubicación
                            <select name="location" class="text-gray-900 searchable-select w-full">
                    ...
                    <div class="mb-6">
                        <label class="texto-verde text-lg">
                            Categoría
                            <select name="category" class="outline-none bg-transparent w-full mb-6 text-lg text-gray-900">
