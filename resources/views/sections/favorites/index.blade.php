<x-profile.index>
    {{-- favoritos --}}
    <div class="favorites w-full px-4">
                    ...
                    <div
                        ...
                        <div class="py-1">
                            <x-form ruta-siguiente="favorites.destroy" :parametro="$favorite->id" metodo="DELETE">
                                <button type="submit" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100 w-full max">Quitar favorito</button>
                            </x-form>
                        </div>
                    </div>
                </div>
                <div class="px-3 py-4 relative z-20">
                    <h2 class="text-gray-800 text-2xl md:text-2xl font-bold mb-2 w-full">{{ $favorite->name }}</h2>
                    <span class="texto-verde font-bold text-xl capitalize">{{ $favorite->getPurpose() }}</span>
