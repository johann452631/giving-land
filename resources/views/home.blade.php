    ...
    <div class="relative py-10 px-20 z-10 bg-gris w-full flex flex-col items-center texto-gris-claro">
        <div class="w-full border-b border-gray-50 mb-5 pb-5 flex justify-between">
            <div class="flex flex-col items-center">
                ...
                <span class="font-bold texto-gris-claro">Establece un vínculo</span>
            </div>
        ...
        <div class="w-1/4 flex justify-between pt-3">
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" class="svg-gris-claro bi bi-facebook"
                    viewBox="0 0 16 16">
                    <path
            ...
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                    class="svg-gris-claro bi bi-instagram" viewBox="0 0 16 16">
                    <path
            ...
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                    class="svg-gris-claro bi bi-twitter-x" viewBox="0 0 16 16">
                    <path
            ...
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                    class="svg-gris-claro bi bi-linkedin" viewBox="0 0 16 16">
                    <path
